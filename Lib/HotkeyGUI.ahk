; This is a modification of jballi's hotkey gui (http://www.autohotkey.com/board/topic/15577-function-hotkeygui-v04/#entry101402)
; and is based on the modified version by rbrtryn http://www.autohotkey.com/board/topic/15577-function-hotkeygui-v04/page__st__15#entry452861)
; The version below separates letters, numbers, symbols and other standard keys into separate categories
; as opposed to the earlier versions of the other authors that combine these categories in one entry.
...
,xm y%YPos% w340 h195
,Keys
Static HG_LetterKeysView
gui %s_GUI%:Add
,Radio
,xp+10 yp+20 Checked Section vHG_LetterKeysView gHotkeyGUI_UpdateKeyList
,Letters

Static HG_NumberKeysView
gui %s_GUI%:Add
,Radio
,xs vHG_NumberKeysView gHotkeyGUI_UpdateKeyList
,Numbers
Static HG_SymbolKeysView
gui %s_GUI%:Add
,Radio
,xs vHG_SymbolKeysView gHotkeyGUI_UpdateKeyList
,Symbols
...
Static HG_OtherStandardKeysView
gui %s_GUI%:Add
,Radio
,xs vHG_OtherStandardKeysView gHotkeyGUI_UpdateKeyList
,Other standard keys
...
gui %s_GUI%:Add
,ListBox			 ;-- ListBox1
,xs+140 ys w180 h165 vHG_Key gHotkeyGUI_UpdateHotkey
;-- Set initial values
...
{
;-- Letter keys
if Instr("|" . l_LetterKeysList . "|","|" . l_Hotkey . "|")
GUIControl %s_GUI%:,HG_LetterKeysView,1
;-- Number keys
if Instr("|" . l_NumberKeysList . "|","|" . l_Hotkey . "|")
GUIControl %s_GUI%:,HG_NumberKeysView,1
;-- Symbol keys
if Instr("|" . l_SymbolKeysList . "|","|" . l_Hotkey . "|")
GUIControl %s_GUI%:,HG_SymbolKeysView,1
;-- Other Standard keys
if Instr("|" . l_OtherStandardKeysList . "|","|" . l_Hotkey . "|")
GUIControl %s_GUI%:,HG_OtherStandardKeysView,1
;-- Function keys
...
if (HG_Key)
GUIControl %s_GUI%:Enable,Button21
else
GUIControl %s_GUI%:Disable,Button21
...
gui %s_GUI%:Submit,NoHide
;-- Letter keys
if HG_LetterKeysView
l_KeysList:=l_LetterKeysList
else
;-- Number keys
if HG_NumberKeysView
l_KeysList:=l_NumberKeysList
else
;-- Symbol keys
if HG_SymbolKeysView
l_KeysList:=l_SymbolKeysList
else
	 ;-- Other standard keys
if HG_OtherStandardKeysView
	 l_KeysList:=l_OtherStandardKeysList
	 else
	 ;-- Function keys
